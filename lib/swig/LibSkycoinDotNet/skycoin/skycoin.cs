...
public class skycoin {
  ...
  public static SWIGTYPE_p_BlockHeader__Handle new_BlockHeader__HandlePtr() {
    global::System.IntPtr cPtr = skycoinPINVOKE.new_BlockHeader__HandlePtr();
    SWIGTYPE_p_BlockHeader__Handle ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_BlockHeader__Handle(cPtr, false);
    return ret;
  }

  public static SWIGTYPE_p_BlockHeader__Handle copy_BlockHeader__HandlePtr(SWIGTYPE_p_BlockHeader__Handle value) {
    global::System.IntPtr cPtr = skycoinPINVOKE.copy_BlockHeader__HandlePtr(SWIGTYPE_p_BlockHeader__Handle.getCPtr(value));
    SWIGTYPE_p_BlockHeader__Handle ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_BlockHeader__Handle(cPtr, false);
    if (skycoinPINVOKE.SWIGPendingException.Pending) throw skycoinPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static void delete_BlockHeader__HandlePtr(SWIGTYPE_p_BlockHeader__Handle obj) {
    skycoinPINVOKE.delete_BlockHeader__HandlePtr(SWIGTYPE_p_BlockHeader__Handle.getCPtr(obj));
  }

  public static void BlockHeader__HandlePtr_assign(SWIGTYPE_p_BlockHeader__Handle obj, SWIGTYPE_p_BlockHeader__Handle value) {
    skycoinPINVOKE.BlockHeader__HandlePtr_assign(SWIGTYPE_p_BlockHeader__Handle.getCPtr(obj), SWIGTYPE_p_BlockHeader__Handle.getCPtr(value));
    if (skycoinPINVOKE.SWIGPendingException.Pending) throw skycoinPINVOKE.SWIGPendingException.Retrieve();
  }

  public static SWIGTYPE_p_BlockHeader__Handle BlockHeader__HandlePtr_value(SWIGTYPE_p_BlockHeader__Handle obj) {
    SWIGTYPE_p_BlockHeader__Handle ret = new SWIGTYPE_p_BlockHeader__Handle(skycoinPINVOKE.BlockHeader__HandlePtr_value(SWIGTYPE_p_BlockHeader__Handle.getCPtr(obj)), true);
    return ret;
  }
...
var tmps = s;
  ...
  public static uint SKY_coin_BlockHeader_Hash(SWIGTYPE_p_BlockHeader__Handle p0, cipher_SHA256 p1) {
    uint ret = skycoinPINVOKE.SKY_coin_BlockHeader_Hash__SWIG_0(SWIGTYPE_p_BlockHeader__Handle.getCPtr(p0), cipher_SHA256.getCPtr(p1));
    if (skycoinPINVOKE.SWIGPendingException.Pending) throw skycoinPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static uint SKY_coin_BlockHeader_UxHash(SWIGTYPE_p_BlockHeader__Handle p0, cipher_SHA256 p1) {
    uint ret = skycoinPINVOKE.SKY_coin_BlockHeader_UxHash__SWIG_0(SWIGTYPE_p_BlockHeader__Handle.getCPtr(p0), cipher_SHA256.getCPtr(p1));
    if (skycoinPINVOKE.SWIGPendingException.Pending) throw skycoinPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static uint SKY_coin_VerifyInputSignatures(SWIGTYPE_p_Transaction__Handle handle, coin_UxOutArray __uxIn) {
    uint ret = skycoinPINVOKE.SKY_coin_VerifyInputSignatures__SWIG_0(SWIGTYPE_p_Transaction__Handle.getCPtr(handle), coin_UxOutArray.getCPtr(__uxIn));
    if (skycoinPINVOKE.SWIGPendingException.Pending) throw skycoinPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
...
var tmpp1 = cipher_SecKey.getCPtr (p1);
    {
      uint ret = skycoinPINVOKE.SKY_coin_BlockHeader_UxHash__SWIG_1(SWIGTYPE_p_BlockHeader__Handle.getCPtr(p0), tmpp1);
      if (skycoinPINVOKE.SWIGPendingException.Pending) throw skycoinPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    }
  }
...
var tmpp1 = cipher_SecKey.getCPtr (p1);
  ...
  public static uint SKY_coin_VerifyInputSignatures(SWIGTYPE_p_Transaction__Handle p0, GoSlice p1) {
    uint ret = skycoinPINVOKE.SKY_coin_VerifyInputSignatures__SWIG_1(SWIGTYPE_p_Transaction__Handle.getCPtr(p0), GoSlice.getCPtr (p1));
    if (skycoinPINVOKE.SWIGPendingException.Pending) throw skycoinPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
