...
namespace LibskycoinNetTest
{
    ...
    public class check_coin_transactions : skycoin.skycoin
    {
        ...
        //     var tx = transutils.makeTransaction();
        //     SKY_coin_Transaction_SetInnerHash(tx, new cipher_SHA256());
        //     var err = SKY_coin_Transaction_Verify(tx);
        //     Assert.AreEqual(err, SKY_ERROR);

        //     // No inputs
        //     tx = transutils.makeTransaction();
        ...
        //     Assert.AreEqual(err, SKY_OK, "SKY_coin_Transaction_ResetOutputs faild");
        //     err = SKY_coin_Transaction_UpdateHeader(tx);
        //     Assert.AreEqual(err, SKY_OK);
        //     err = SKY_coin_Transaction_Verify(tx);
        //     Assert.AreEqual(err, SKY_ERROR);
        ...
        //     tx = transutils.makeTransaction();
        //     err = SKY_coin_Transaction_ResetSignatures(tx, ushort.MaxValue + 1);
        //     Assert.AreEqual(err, SKY_OK);
        //     err = SKY_coin_Transaction_ResetInputs(tx, ushort.MaxValue + 1);
        //     Assert.AreEqual(err, SKY_OK);
        //     err = SKY_coin_Transaction_Verify(tx);
        //     Assert.AreEqual(err, SKY_ERROR);
        ...
        //     var ux = transutils.makeUxOutWithSecret(s);
        //     tx = transutils.makeTransactionFromUxOut(ux, s);
        //     err = SKY_coin_Transaction_GetInputAt(tx, 0, h);
        //     Assert.AreEqual(err, SKY_OK);
        //     var r = SKY_coin_Transaction_PushInput(tx, h);
        ...
        //     // Duplicate outputs
        //     tx = transutils.makeTransaction();
        //     var pOutput = new_coin__TransactionOutputPtr();
