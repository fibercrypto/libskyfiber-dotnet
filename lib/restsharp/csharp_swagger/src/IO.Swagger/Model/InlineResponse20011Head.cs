...
{
    /// <summary>
    /// InlineResponse20011Head
    /// </summary>
    [DataContract]
    public partial class InlineResponse20011Head :  IEquatable<InlineResponse20011Head>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011Head" /> class.
        /// </summary>
        ...
        public InlineResponse20011Head(long? Fee = default(long?), string Hash = default(string), string PreviousBlockHash = default(string), long? Seq = default(long?), long? Timestamp = default(long?), string TxBodyHash = default(string), string UxHash = default(string), long? Version = default(long?))
        {
            this.Fee = Fee;
            this.Hash = Hash;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20011Head {\n");
        ...
        {
            return this.Equals(input as InlineResponse20011Head);
        }

        /// <summary>
        /// Returns true if InlineResponse20011Head instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011Head to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011Head input)
        {
            if (input == null)
                return false;
