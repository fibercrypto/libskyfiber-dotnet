...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(InlineResponse2009Blockchain Blockchain = default(InlineResponse2009Blockchain), string Coin = default(string), bool? CspEnabled = default(bool?), bool? CsrfEnabled = default(bool?), bool? GuiEnabled = default(bool?), long? IncomingConnections = default(long?), bool? JsonRpcEnabled = default(bool?), long? OpenConnections = default(long?), long? OutgoingConnections = default(long?), long? StartedAt = default(long?), InlineResponse2009UnconfirmedVerifyTransaction UnconfirmedVerifyTransaction = default(InlineResponse2009UnconfirmedVerifyTransaction), bool? UnversionedApiEnabled = default(bool?), string Uptime = default(string), string UserAgent = default(string), InlineResponse2009UnconfirmedVerifyTransaction UserVerifyTransaction = default(InlineResponse2009UnconfirmedVerifyTransaction), InlineResponse2009Version Version = default(InlineResponse2009Version), bool? WalletApiEnabled = default(bool?))
        {
        ...
        public InlineResponse2009Blockchain Blockchain { get; set; }
        ...
        public InlineResponse2009UnconfirmedVerifyTransaction UnconfirmedVerifyTransaction { get; set; }
        ...
        public InlineResponse2009UnconfirmedVerifyTransaction UserVerifyTransaction { get; set; }

        /// <summary>
        /// Gets or Sets Version
        /// </summary>
        [DataMember(Name="version", EmitDefaultValue=false)]
        public InlineResponse2009Version Version { get; set; }
