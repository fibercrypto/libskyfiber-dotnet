...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(InlineResponse2003Body Body = default(InlineResponse2003Body), InlineResponse2003Header Header = default(InlineResponse2003Header), int? Size = default(int?))
        {
            this.Body = Body;
            this.Header = Header;
            this.Size = Size;
        ...
        public InlineResponse2003Body Body { get; set; }

        /// <summary>
        /// Gets or Sets Header
        /// </summary>
        [DataMember(Name="header", EmitDefaultValue=false)]
        public InlineResponse2003Header Header { get; set; }
