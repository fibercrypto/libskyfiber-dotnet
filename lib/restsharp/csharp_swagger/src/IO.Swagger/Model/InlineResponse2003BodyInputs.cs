...
{
    /// <summary>
    /// InlineResponse2003BodyInputs
    /// </summary>
    [DataContract]
    public partial class InlineResponse2003BodyInputs :  IEquatable<InlineResponse2003BodyInputs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003BodyInputs" /> class.
        /// </summary>
        ...
        public InlineResponse2003BodyInputs(long? CalculatedHours = default(long?), string Coins = default(string), string Dst = default(string), long? Hours = default(long?), string Uxid = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2003BodyInputs {\n");
        ...
        {
            return this.Equals(input as InlineResponse2003BodyInputs);
        }

        /// <summary>
        /// Returns true if InlineResponse2003BodyInputs instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003BodyInputs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003BodyInputs input)
        {
            if (input == null)
                return false;
