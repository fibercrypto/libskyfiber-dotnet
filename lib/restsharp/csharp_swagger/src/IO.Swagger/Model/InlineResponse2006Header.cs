...
{
    /// <summary>
    /// InlineResponse2006Header
    /// </summary>
    [DataContract]
    public partial class InlineResponse2006Header :  IEquatable<InlineResponse2006Header>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2006Header" /> class.
        /// </summary>
        ...
        public InlineResponse2006Header(string BlockHash = default(string), long? Fee = default(long?), string PreviousBlockHash = default(string), long? Seq = default(long?), long? Timestamp = default(long?), string TxBodyHash = default(string), string UxHash = default(string), int? Version = default(int?))
        {
        ...
        {
            return this.Equals(input as InlineResponse2006Header);
        }

        /// <summary>
        /// Returns true if InlineResponse2006Header instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2006Header to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2006Header input)
        {
            if (input == null)
                return false;
