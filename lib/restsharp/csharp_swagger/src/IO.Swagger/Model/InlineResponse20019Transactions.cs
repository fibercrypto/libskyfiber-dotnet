...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20019Transactions :  IEquatable<InlineResponse20019Transactions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20019Transactions" /> class.
        /// </summary>
        ...
        public InlineResponse20019Transactions(string Announced = default(string), string _Checked = default(string), bool? IsValid = default(bool?), string Received = default(string), InlineResponse20019Transaction Transaction = default(InlineResponse20019Transaction))
        {
        ...
        public InlineResponse20019Transaction Transaction { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20019Transactions);
        }

        /// <summary>
        /// Returns true if InlineResponse20019Transactions instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20019Transactions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20019Transactions input)
        {
            if (input == null)
                return false;
