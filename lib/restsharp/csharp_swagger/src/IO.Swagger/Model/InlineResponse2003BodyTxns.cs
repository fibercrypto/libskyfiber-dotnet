...
{
    /// <summary>
    /// InlineResponse2003BodyTxns
    /// </summary>
    [DataContract]
    public partial class InlineResponse2003BodyTxns :  IEquatable<InlineResponse2003BodyTxns>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003BodyTxns" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2003BodyTxns {\n");
        ...
        {
            return this.Equals(input as InlineResponse2003BodyTxns);
        }

        /// <summary>
        /// Returns true if InlineResponse2003BodyTxns instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003BodyTxns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003BodyTxns input)
        {
            if (input == null)
                return false;
