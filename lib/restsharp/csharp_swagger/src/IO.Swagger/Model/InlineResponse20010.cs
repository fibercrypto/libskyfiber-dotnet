...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(string Address = default(string), long? ConnectedAt = default(long?), long? Height = default(long?), long? Id = default(long?), bool? IsTrustedPeer = default(bool?), long? LastReceived = default(long?), long? LastSent = default(long?), int? ListenPort = default(int?), int? Mirror = default(int?), bool? Outgoing = default(bool?), StateEnum? State = default(StateEnum?), InlineResponse20010UnconfirmedVerifyTransaction UnconfirmedVerifyTransaction = default(InlineResponse20010UnconfirmedVerifyTransaction), string UserAgent = default(string))
        {
        ...
        public InlineResponse20010UnconfirmedVerifyTransaction UnconfirmedVerifyTransaction { get; set; }
