...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20015Meta :  IEquatable<InlineResponse20015Meta>, IValidatableObject
    {
        /// <summary>
        ...
        public InlineResponse20015Meta(string Coin = default(string), string CryptoType = default(string), bool? Encrypted = default(bool?), string Filename = default(string), string Label = default(string), long? Timestamp = default(long?), string Type = default(string), string Version = default(string))
        {
            this.Coin = Coin;
