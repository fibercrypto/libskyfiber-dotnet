...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20010UnconfirmedVerifyTransaction :  IEquatable<InlineResponse20010UnconfirmedVerifyTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010UnconfirmedVerifyTransaction" /> class.
        /// </summary>
        ...
        public InlineResponse20010UnconfirmedVerifyTransaction(int? BurnFactor = default(int?), int? MaxDecimals = default(int?), int? MaxTransactionSize = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse20010UnconfirmedVerifyTransaction {\n");
        ...
        {
            return this.Equals(input as InlineResponse20010UnconfirmedVerifyTransaction);
        }

        /// <summary>
        /// Returns true if InlineResponse20010UnconfirmedVerifyTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010UnconfirmedVerifyTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010UnconfirmedVerifyTransaction input)
        {
            if (input == null)
                return false;
