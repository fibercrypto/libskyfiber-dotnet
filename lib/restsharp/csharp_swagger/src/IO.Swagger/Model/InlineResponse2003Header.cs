...
{
    /// <summary>
    /// InlineResponse2003Header
    /// </summary>
    [DataContract]
    public partial class InlineResponse2003Header :  IEquatable<InlineResponse2003Header>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003Header" /> class.
        /// </summary>
        ...
        public InlineResponse2003Header(string BlockHash = default(string), int? Fee = default(int?), string PreviousBlockHash = default(string), int? Seq = default(int?), long? Timestamp = default(long?), string TxBodyHash = default(string), string UxHash = default(string), int? Version = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2003Header {\n");
        ...
        {
            return this.Equals(input as InlineResponse2003Header);
        }

        /// <summary>
        /// Returns true if InlineResponse2003Header instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003Header to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003Header input)
        {
            if (input == null)
                return false;
