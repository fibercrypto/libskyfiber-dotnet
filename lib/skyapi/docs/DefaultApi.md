...
# **ExplorerAddress**
> List<Object> ExplorerAddress (string address = null)
...
namespace Example
{
    public class ExplorerAddressExample
    {
        public void main()
        {
            ...
            try
            {
                List&lt;Object&gt; result = apiInstance.ExplorerAddress(address);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
# **NetworkConnections**
> List<Object> NetworkConnections (string states = null, string direction = null)
...
namespace Example
{
    public class NetworkConnectionsExample
    {
        public void main()
        {
            ...
            {
                // This endpoint returns all outgoings connections.
                List&lt;Object&gt; result = apiInstance.NetworkConnections(states, direction);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class PendingTxsExample
    {
        public void main()
        {
            ...
            try
            {
                List&lt;Object&gt; result = apiInstance.PendingTxs();
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
# **WalletTransaction**
> Object WalletTransaction (Body body)
