...
${nuget_cmd} install src/RestCSharp/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/RestCSharp.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/RestCSharp.dll \
-recurse:'src/RestCSharp/*.cs' \
-doc:bin/RestCSharp.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/RestCSharp.dll was created successfully"
fi
