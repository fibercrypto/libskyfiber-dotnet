...
${nuget_cmd} install src/Skyapi/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Skyapi.dll"
...
then
  ...
  echo "[INFO] bin/Skyapi.dll was created successfully"
fi
