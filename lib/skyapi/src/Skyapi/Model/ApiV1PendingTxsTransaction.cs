...
namespace Skyapi.Model
{
    ...
    public partial class ApiV1PendingTxsTransaction :  IEquatable<ApiV1PendingTxsTransaction>, IValidatableObject
    {
        ...
        public ApiV1PendingTxsTransaction(List<ApiV1ExplorerAddressOutputs> outputs = default(List<ApiV1ExplorerAddressOutputs>), string innerHash = default(string), List<string> inputs = default(List<string>), List<string> sigs = default(List<string>), int? length = default(int?), string txid = default(string), int? type = default(int?), int? timestamp = default(int?))
        {
