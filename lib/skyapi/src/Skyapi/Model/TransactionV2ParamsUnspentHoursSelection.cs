...
namespace Skyapi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TransactionV2ParamsUnspentHoursSelection :  IEquatable<TransactionV2ParamsUnspentHoursSelection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionV2ParamsUnspentHoursSelection" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="mode">mode.</param>
        /// <param name="shareFactor">shareFactor.</param>
        public TransactionV2ParamsUnspentHoursSelection(string type = default(string), string mode = default(string), string shareFactor = default(string))
        {
            this.Type = type;
            this.Mode = mode;
        ...
        {
            return this.Equals(input as TransactionV2ParamsUnspentHoursSelection);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(TransactionV2ParamsUnspentHoursSelection input)
        {
            if (input == null)
                return false;
