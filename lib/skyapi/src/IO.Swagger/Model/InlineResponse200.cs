...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(int? coins = default(int?), long? hours = default(long?), string ownerAddress = default(string), int? spentBlockSeq = default(int?), string spentTx = default(string), long? srcBlockSeq = default(long?), string srcTx = default(string), long? time = default(long?), string uxid = default(string))
        {
            this.Coins = coins;
            this.Hours = hours;
