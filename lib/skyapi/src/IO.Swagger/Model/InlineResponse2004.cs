...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(string announced = default(string), string _checked = default(string), bool? isValid = default(bool?), string received = default(string), Apiv1pendingTxsTransaction transaction = default(Apiv1pendingTxsTransaction))
        {
