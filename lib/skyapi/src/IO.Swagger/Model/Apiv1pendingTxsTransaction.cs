...
namespace IO.Swagger.Model
{
    ...
    public partial class Apiv1pendingTxsTransaction :  IEquatable<Apiv1pendingTxsTransaction>, IValidatableObject
    {
        ...
        public Apiv1pendingTxsTransaction(string innerHash = default(string), List<string> inputs = default(List<string>), int? length = default(int?), List<Apiv1exploreraddressOutputs> outputs = default(List<Apiv1exploreraddressOutputs>), List<string> sigs = default(List<string>), int? timestamp = default(int?), string txid = default(string), int? type = default(int?))
        {
