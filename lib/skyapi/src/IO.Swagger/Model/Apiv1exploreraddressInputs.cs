...
namespace IO.Swagger.Model
{
    ...
    public partial class Apiv1exploreraddressInputs :  IEquatable<Apiv1exploreraddressInputs>, IValidatableObject
    {
        ...
        public Apiv1exploreraddressInputs(long? calculatedHours = default(long?), string coins = default(string), long? hours = default(long?), string owner = default(string), string uxid = default(string))
        {
