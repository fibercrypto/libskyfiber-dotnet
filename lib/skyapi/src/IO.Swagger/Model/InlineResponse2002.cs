...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        public InlineResponse2002(int? fee = default(int?), string innerHash = default(string), List<Apiv1exploreraddressInputs> inputs = default(List<Apiv1exploreraddressInputs>), long? length = default(long?), List<Apiv1exploreraddressOutputs> outputs = default(List<Apiv1exploreraddressOutputs>), List<string> sigs = default(List<string>), Apiv1exploreraddressStatus status = default(Apiv1exploreraddressStatus), int? timestamp = default(int?), string txid = default(string), int? type = default(int?))
        {
            this.Fee = fee;
