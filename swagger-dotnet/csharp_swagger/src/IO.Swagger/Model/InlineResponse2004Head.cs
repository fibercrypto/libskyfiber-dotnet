...
{
    /// <summary>
    /// InlineResponse2004Head
    /// </summary>
    [DataContract]
    public partial class InlineResponse2004Head :  IEquatable<InlineResponse2004Head>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004Head" /> class.
        /// </summary>
        ...
        public InlineResponse2004Head(string BlockHash = default(string), long? Fee = default(long?), string PreviousBlockHash = default(string), string Seq = default(string), long? Timestamp = default(long?), string TxBodyHash = default(string), string UxHash = default(string), long? Version = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2004Head {\n");
        ...
        {
            return this.Equals(input as InlineResponse2004Head);
        }

        /// <summary>
        /// Returns true if InlineResponse2004Head instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004Head to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004Head input)
        {
            if (input == null)
                return false;
