...
{
    /// <summary>
    /// InlineResponse2009UnconfirmedVerifyTransaction
    /// </summary>
    [DataContract]
    public partial class InlineResponse2009UnconfirmedVerifyTransaction :  IEquatable<InlineResponse2009UnconfirmedVerifyTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2009UnconfirmedVerifyTransaction" /> class.
        /// </summary>
        ...
        public InlineResponse2009UnconfirmedVerifyTransaction(long? BurnFactor = default(long?), long? MaxDecimal = default(long?), long? MaxTransactionSize = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2009UnconfirmedVerifyTransaction {\n");
        ...
        {
            return this.Equals(input as InlineResponse2009UnconfirmedVerifyTransaction);
        }

        /// <summary>
        /// Returns true if InlineResponse2009UnconfirmedVerifyTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2009UnconfirmedVerifyTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2009UnconfirmedVerifyTransaction input)
        {
            if (input == null)
                return false;
